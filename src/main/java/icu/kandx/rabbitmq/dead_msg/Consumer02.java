...
public class Consumer02 {
    ...
    public static final String QUEUE_NAME01 = "dead_queue";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
         ...
         *       2. 交换机名称
         *       3. RoutingKey 路由键 */
        channel.queueBind(QUEUE_NAME01, EXCHANGE_NAME, "lisi");
        ...
        channel.basicConsume(QUEUE_NAME01,true, deliverCallback, cancelCallback);
    }
}
